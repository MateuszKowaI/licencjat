...
\section{Zadania i ograniczenia komputera pokładowego}
    ...
    \section{Lista komponentów i ich specyfikacja}
        ...
        systemów satelit geolokacyjnych: europejskich satelit Galileo, amerykańskich GPS, rosyjskich GLONASS i chińskich BeiDou. Oferowana dokładność wyznaczonej pozycji to 
        ...
        Asystentem dla Pixhawk 6C jest mikrokomputer Raspberry Pi 5B. Posiada on czterordzeniowy procesor Arm Cortex-A76, 8GB RAM oraz szereg sposobów na podłączenie urządzeń 
        peryferyjnych, np. cztery gniazda USB czy 40 pinów GPIO.
        \subsection{Źródło zasilania}
        BSP zasilany jest za pomocą akumulatora litowo-jonowego Gens Ace G-Tech o pojemności 5000 mAh, napięciu 14.8V i wadze 439g.
    \section{Specyfikacja drona (waga, czas lotu itp)}
    \section{Wykorzystane oprogramowanie}
        \subsection{Oprogramowanie komputera pokładowego}
        \subsection{Oprogramowanie komputera asystującego}
