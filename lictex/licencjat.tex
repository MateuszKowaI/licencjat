...
\section{Zadania i ograniczenia komputera pokładowego}
    ...
    \section{Lista komponentów i ich specyfikacja}
        \subsection{Rama BSP}
        Rama użyta do zbudowania jednostki to Holybro S500 v2. Oferuje wbudowaną w konstrukcję kadłuba rozdzielnicę napięcia (ang. power distribution board) dostarczającą energię elektryczną
        ...
        potrzebne są moduły elektronicznej kontroli prędkości (ang. electronic speed controller). Moduły te otrzymują zasilanie prądem stałym z akumulatora oraz sygnał z komputera pokładowego 
